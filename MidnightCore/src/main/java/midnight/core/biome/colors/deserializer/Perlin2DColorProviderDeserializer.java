...
import midnight.core.biome.colors.provider.Perlin2DColorProvider;

public class Perlin2DColorProviderDeserializer implements IColorProviderDeserializer {
    @Override
    public IColorProvider deserialize(JsonElement element, ColorDeserializeContext ctx) throws ColorDeserializeException {
        if (element.isJsonObject()) {
            ...
            return new Perlin2DColorProvider(a, b, octaves, sizeX, sizeZ);
        } else {

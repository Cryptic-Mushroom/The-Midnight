...
import midnight.core.biome.colors.provider.Perlin3DColorProvider;

public class Perlin3DColorProviderDeserializer implements IColorProviderDeserializer {
    @Override
    public IColorProvider deserialize(JsonElement element, ColorDeserializeContext ctx) throws ColorDeserializeException {
        if (element.isJsonObject()) {
            ...
            return new Perlin3DColorProvider(a, b, octaves, sizeX, sizeY, sizeZ);
        } else {

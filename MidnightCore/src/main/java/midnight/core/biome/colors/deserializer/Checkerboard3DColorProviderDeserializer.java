...
import midnight.core.biome.colors.provider.Checkerboard3DColorProvider;

public class Checkerboard3DColorProviderDeserializer implements IColorProviderDeserializer {
    @Override
    public IColorProvider deserialize(JsonElement element, ColorDeserializeContext ctx) throws ColorDeserializeException {
        if (element.isJsonArray()) {
            ...
            return new Checkerboard3DColorProvider(a, b, 1, 1, 1);
            ...
            return new Checkerboard3DColorProvider(a, b, sizeX, sizeY, sizeZ);
        } else {

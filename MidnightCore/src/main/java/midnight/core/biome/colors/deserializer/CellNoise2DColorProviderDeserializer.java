...
import midnight.core.biome.colors.provider.CellNoise2DColorProvider;
...
public class CellNoise2DColorProviderDeserializer implements IColorProviderDeserializer {
    ...
    public IColorProvider deserialize(JsonElement element, ColorDeserializeContext ctx) throws ColorDeserializeException {
        if (element.isJsonArray()) {
            ...
            return new CellNoise2DColorProvider(a, b, 1, 1);
            ...
            return new CellNoise2DColorProvider(a, b, sizeX, sizeZ);
        } else {

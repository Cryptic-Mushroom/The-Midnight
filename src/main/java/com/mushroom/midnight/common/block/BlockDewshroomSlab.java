...
public class BlockDewshroomSlab extends BlockSlab {
    ...
    public BlockDewshroomSlab(boolean isDouble) {
    ...
    public static enum EnumType implements IStringSerializable {
        ...
        static {
            for (BlockDewshroomSlab.EnumType blockdewshroomslab$enumtype : values()) {
                META_LOOKUP[blockdewshroomslab$enumtype.getMetadata()] = blockdewshroomslab$enumtype;
            }
        }
    }

...
public class BlockDeadWoodStairs extends BlockStairs implements IModelProvider {
	...
	public BlockDeadWoodStairs() {
		
		super(ModBlocks.DEAD_WOOD_PLANKS.getDefaultState());

...
/** this class is a copy of vanilla EntityArrow to be able to change the sound on hit */
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.createKey(EntityProjectile.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public abstract SoundEvent getSoundOnHit();
    ...
    protected void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (entity != null) {
            ...
            if (entity.attackEntityFrom(damagesource, (float) i)) {
                ...
                this.playSound(getSoundOnHit(), 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));

...
public class NightMyceliumBlock extends NightDirtBlock implements Fertilizable {
    public NightMyceliumBlock(Settings props) {
        super(props);
    }
        ...
        for (int i = 0; i < 128; ++i) {
            ...
            while (true) {
                if (j >= i / 16) {
                    ...
                    if (currState.getBlock() instanceof Fertilizable && rand.nextInt(10) == 0) {
                    ...
                    if (plant.canPlaceAt(world, placePos)) {
                        world.setBlockState(placePos, plant, 3);
                    }
                    break;
                }

...
import midnight.common.util.MidnightDamageSource;
...
public class BladeshroomBlock extends MidnightPlantBlock implements IGrowable {
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult rayTraceResult) {
        if (state.get(STAGE) == Stage.CAPPED) {
            ItemHandlerHelper.giveItemToPlayer(player, new ItemStack(MnItems.BLADESHROOM_CAP));
    ...
    public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
        return new ItemStack(MnItems.BLADESHROOM_SPORES);
    }

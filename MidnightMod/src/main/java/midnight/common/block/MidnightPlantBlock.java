...
public class MidnightPlantBlock extends BushBlock implements IGrowable, GeneratablePlant {
    ...
    public MidnightPlantBlock(Properties properties) {
        this(properties, false, null);
    }

    public MidnightPlantBlock(Properties properties, boolean glowing) {
        this(properties, glowing, null);
    }

    public MidnightPlantBlock(Properties properties, boolean glowing, @Nullable Supplier<Block> growSupplier) {
        super(properties.setLightLevel(blockstate -> glowing ? 12 : 0));

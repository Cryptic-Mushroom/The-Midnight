...
public class FurnaceFlameParticle extends SpriteTexturedParticle {
    ...
    public FurnaceFlameParticle(IAnimatedSprite spriteSet, ClientWorld world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
